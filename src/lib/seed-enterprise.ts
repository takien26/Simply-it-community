...
async function main() {
  console.log('🌱 Seeding Enterprise Support Teams, Queues, and Routing Rules...');
  ...
  console.log('✅ Created/Updated 6 Enterprise Teams & Queues');
  ...
  console.log('✅ Created/Updated 5 Standard Routing Rules');
}
